...
1. Set up your environment https://reactnative.dev/docs/set-up-your-environment
...
For more info, read [README.md](/example/README.md) in example project.
...
For iOS, first time you must install pods in example app:
cd example/ios
bundle install
bundle exec pod install
...
```sh
Running "TrackingplanReactNativeExample" with {"fabric":true,"initialProps":{"concurrentRoot":true},"rootTag":1}
```
